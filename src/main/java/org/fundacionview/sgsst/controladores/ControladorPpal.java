...
public class ControladorPpal {
	...
	public String index() {
		 ...
		 * 
		 * ArrayList<CIE10>
		 * listaDiagnosti3=repoDiagnosticos.consultaPorDiagnostico_Codigo("");
		 * 
	...
	public String guardarEmpleado(@Valid @ModelAttribute("empleado") Empleado e, Model mod, BindingResult rv) {
	...
	public String guardarIncapacidad(@Valid @ModelAttribute("ausentismo") Ausentismo a, Model mod, BindingResult rv) {
		...
		if (rv.hasErrors()) {
			return "redirect:/crearIncapacidad";
		} else {
	...
	public String eliminarUsuario(Model mod, @RequestParam("id") Long id) {
