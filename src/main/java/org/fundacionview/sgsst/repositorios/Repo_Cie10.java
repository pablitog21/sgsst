...
public interface Repo_Cie10 extends JpaRepository<CIE10, Integer> {
	...
	@Query(value = "FROM CIE10 WHERE diagnostico like :diagnosticos", nativeQuery = true)
	public ArrayList<CIE10> getDiagnistico(@Param("diagnostico") String diagnostico);
	...
	@Query("FROM CIE10 WHERE id IN (12052,12067)")
