      ...
      <div class="col">
        ...
        <div class="d-nonx mt-2">
          ...
          <div class="mb-3">
            ...
            <form:input type="text" path="numID" class="form-control" id="IDEmpleado" />
          </div>
        ...
        <div class="d-nonx mt-2">
          ...
          <div class="mb-3">        
            ...
            <form:input path="salarioDia" type="text" class="form-control" id="salarioDia" />
        ...
        <div class="mb-3 autocompleteBS">
          ...
          <form:input path="fechaInicial" type="date" class="form-control" id="fechaIni" onblur="calcularSalario()" />
        ...
        <div class="d-nonx mt-2">
          ...
          <div class="mb-3">       
            ...
            <form:input path="fechaFin" type="date" class="form-control" id="fechaFin" onchange="calcularDias()" />
        ...
        <div class="d-nonx mt-2">
          ...
          <div class="mb-3">
            ...
            <form:input path="totalDias" type="text" class="form-control" id="totalDias" />
        ...
        <div class="mb-3">
          <label for="inputText1" class="form-label">Tipo Incapacidad</label>
          <form:select path="tipoIncapacidad"  class="form-select" id="tipoIncapacidad">
          	<form:option value="">-Seleccionar</form:option>
        ...
        <button type="submin" class="btn btn-primary">Enviar</button>
